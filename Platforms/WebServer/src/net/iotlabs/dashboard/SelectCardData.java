 ...
 * 여러건 조회 하는 경우
 */
@WebServlet("/servlet/dashboard/SelectCardData")
public class SelectCardData extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, String> result = dao.commonSelectOne("DashboardMapper." + this.getClass().getSimpleName(), p);
